...
class __TwigTemplate_a104d6fc8580de88a6f523a10a6d81ee200b229a9b990e36f0e9dbf9edff6cb5 extends \Twig\Template
{
...
($context["path"] ?? null) == "/user/register")) {
      ...
      ";
            ...
            if ((($context["site_register"] ?? null) != "admin_only")) {
                ...
                echo "          <a href=\"";
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["base_path"] ?? null)), "html", null, true);
                echo "licensee\" class=\"signreg\">Sign up</a>
        ";
            }
            // line 12
            echo "      ";
    ...
    <div class=\"simplelogin-link\">
      ...
      {% else %}
        {% if site_register != \"admin_only\" %}
          <a href=\"{{ base_path }}licensee\" class=\"signreg\">Sign up</a>
        {% endif %}
      {% endif %}
    </div>
...
", "modules/contrib/simplelogin/templates/page--simplelogin.html.twig", "/Applications/MAMP/htdocs/dalro-project/dalro-dev/modules/contrib/simplelogin/templates/page--simplelogin.html.twig");
    }
}
